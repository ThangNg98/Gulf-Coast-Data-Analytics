    ...
    <div class="container"> 
        <form @submit.prevent="submitForm">
            ...
            <div style="text-align:right; margin-top: 2rem;">
                <button type="submit" class="btn btn-success" style="margin-right:0.5rem; text-align:left" > <router-link class="nav-link" to="/events"> Back to Events</router-link></button>
